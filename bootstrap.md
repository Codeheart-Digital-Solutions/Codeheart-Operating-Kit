...
```text
Version: v0.1.28
Release URL: https://github.com/Codeheart-Digital-Solutions/Codeheart-Operating-Kit/releases/tag/v0.1.28
```
...
`codeheart-operating-kit-0.1.28-macos-universal.zip`; the pack contains
`bin/codeheart-operating-kit`.

```sh
curl -fsSLO https://github.com/Codeheart-Digital-Solutions/Codeheart-Operating-Kit/releases/download/v0.1.28/install.sh
bash install.sh
```
...
`codeheart-operating-kit-0.1.28-windows-x64.zip`; the pack contains
`bin/codeheart-operating-kit.exe` and the installer writes the `.cmd` shim.

```powershell
Invoke-WebRequest -Uri "https://github.com/Codeheart-Digital-Solutions/Codeheart-Operating-Kit/releases/download/v0.1.28/install.ps1" -OutFile install.ps1
.\install.ps1
```
...
For `v0.1.28`, `codeheart-operating-kit onboard` is an agent-guided script and setup-plan renderer.
