...
- Operation routing and dispatch standard implementation plan:
  `operation-routing-dispatch-standard/operation-routing-dispatch-standard_implementation_doc.md`
- Operation routing and dispatch standard execution log:
  `operation-routing-dispatch-standard/operation-routing-dispatch-standard_execution_log.md`
...
- Plan-register dirty target safety execution log:
  `plan-register-dirty-target-safety/plan-register-dirty-target-safety_execution_log.md`
...
- Portfolio coordination and plan-register implementation plan:
  `portfolio-coordination-plan-register/portfolio-coordination-plan-register_implementation_doc.md`
- Portfolio coordination and plan-register execution log:
  `portfolio-coordination-plan-register/portfolio-coordination-plan-register_execution_log.md`
