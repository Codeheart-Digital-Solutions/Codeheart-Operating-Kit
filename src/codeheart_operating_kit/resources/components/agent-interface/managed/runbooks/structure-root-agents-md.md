...
Use this runbook when creating a consumer root `AGENTS.md`.

## Procedure

1. Add the Operating Kit managed block with stable boundary markers.
2. Include immediate universal rules for protecting work, destructive actions, external-state
   changes, secrets, task-matched reading, and managed kit ownership.
...
Confirm that the managed block is short, route-focused, and repairable without replacing local
instructions.
